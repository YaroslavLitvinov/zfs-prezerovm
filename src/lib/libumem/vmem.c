...
#ifdef DEBUG
#if 0
	printf("vmem_populate::LOCK vmpl_thr=%u, thr_self()=%u\n", 
	       lp->vmpl_thr, thr_self() );
#endif
#endif
...
#ifdef DEBUG
#if 0
	printf("vmem_populate::UNLOCK vmpl_thr=%u, thr_self()=%u\n", 
	       lp->vmpl_thr, thr_self() );
#endif
#endif
		vmem_reap();
...
#ifdef DEBUG
#if 0
	printf("vmem_populate::UNLOCK2 vmpl_thr=%u, thr_self()=%u\n", 
	       lp->vmpl_thr, thr_self() );
#endif
#endif
	/*
